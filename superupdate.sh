...
setDebian(){
	...
	echo "deb http://cdn-fastly.deb.debian.org/debian/ buster main non-free contrib" >>/etc/apt/sources.list
	echo "deb http://cdn-fastly.deb.debian.org/debian/ buster-updates main non-free contrib" >>/etc/apt/sources.list
	echo "deb http://cdn-fastly.deb.debian.org/debian/ buster-backports main non-free contrib" >>/etc/apt/sources.list
	echo "deb-src http://cdn-fastly.deb.debian.org/debian/ buster main non-free contrib" >>/etc/apt/sources.list
	echo "deb-src http://cdn-fastly.deb.debian.org/debian/ buster-updates main non-free contrib" >>/etc/apt/sources.list
	echo "deb-src http://cdn-fastly.deb.debian.org/debian/ buster-backports main non-free contrib" >>/etc/apt/sources.list
	echo "deb http://cdn-fastly.deb.debian.org/debian-security/ buster/updates main non-free contrib" >>/etc/apt/sources.list
	echo "deb-src http://cdn-fastly.deb.debian.org/debian-security/ buster/updates main non-free contrib" >>/etc/apt/sources.list
